                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    <?php if ($b['trang_thai'] === 'DaXacNhan'): ?>
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="<?= BASE_URL ?>routes/index.php?action=booking-status&id=<?= $b['id'] ?>&status=Huy" onclick="return confirm('Xác nhận hủy đơn này? Hành động sẽ trả lại chỗ trống cho tour.')">
                                                                <i class="fas fa-times me-2"></i> Hủy đơn
                                                            </a>
                                                        </li>
                                                    <?php elseif ($b['trang_thai'] === 'Huy'): ?>
                                                        <li>
                                                            <a class="dropdown-item text-warning" href="<?= BASE_URL ?>routes/index.php?action=booking-status&id=<?= $b['id'] ?>&status=DaXacNhan" onclick="return confirm('Khôi phục đơn hàng này?')">
