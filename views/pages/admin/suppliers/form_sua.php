        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">Cập Nhật Thông Tin: <?= $supplier['ten_ncc'] ?></h5>
                </div>
                <div class="card-body p-4">
                    <form action="index.php?action=admin-supplier-update" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ten_ncc" class="form-control" value="<?= $supplier['ten_ncc'] ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label fw-bold">Loại Dịch Vụ</label>
                            <input type="text" name="dich_vu" class="form-control" value="<?= $supplier['dich_vu'] ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="dia_chi" class="form-control" rows="2"><?= $supplier['dia_chi'] ?></textarea>
                        </div>
